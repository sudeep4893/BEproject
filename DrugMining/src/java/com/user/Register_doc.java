...
public class Register_doc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(rs.getInt(1)==0)
            {
                connect.executeUpdate("Insert into users (id,fullname,username,password,address,email,contact_no,user_type) values(null,'"+name+"','"+username+"','"+password+"','"+address+"','"+email+"','"+contact+"','doctor')");
