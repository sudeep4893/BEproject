...
String s = null;
      ...
      out.write("\n");
      out.write("<div class=\"container\">\n");
      out.write("    <div class=\"row background space20\">\n");
      out.write("        <div class=\"span12\">\n");
      out.write("            ");
if (user == null) {
      out.write("\n");
      out.write("            <form class=\"form-signin\" action=\"Register_user\" method=\"post\">\n");
      out.write("                <h2 class=\"form-signin-heading\">Add Medicine Details </h2>\n");
      out.write("                <span class=\"label label-info\">Enter Full name</span>\n");
      out.write("                <input type=\"text\" class=\"input-block-level validate[required]\" placeholder=\"full name\" name=\"fullname\"/>\n");
      out.write("                <span class=\"label label-info\">Enter User name</span>\n");
      out.write("                <input type=\"text\" class=\"input-block-level validate[required]\" placeholder=\"username\" name=\"username\"/>\n");
      out.write("                <span class=\"label label-info\">Enter Password</span>\n");
      out.write("                <input type=\"password\" class=\"input-block-level validate[required]\" placeholder=\"password\" name=\"password\"/>\n");
      out.write("                <span class=\"label label-info\">Enter Address</span>\n");
      out.write("                <input type=\"text\" class=\"input-block-level validate[required]\" placeholder=\"address\" name=\"address\"/>\n");
      out.write("                <span class=\"label label-info\">Email Address</span>\n");
      out.write("                <input type=\"text\" class=\"input-block-level validate[required, custom[email]]\" placeholder=\"Email Address\" name=\"email\"/>\n");
      out.write("                <span class=\"label label-info\">Enter Phone number</span>\n");
      out.write("                <input type=\"number\" class=\"input-block-level validate[required, custom[phone]]\" placeholder=\"Phone Number\" name=\"contact\"/>\n");
      out.write("                <button align=\"middle\" class=\"btn btn-large btn-primary\" type=\"submit\" align=\"center\" >Register</button>\n");
      out.write("            </form>\n");
      out.write("                ");
 } else {
        if (user.equals("admin")) {
      out.write("\n");
      out.write("                    <form class=\"form-signin\" action=\"Register_doc\" method=\"post\">\n");
      out.write("                <h2 class=\"form-signin-heading\">Add a Doctor</h2>\n");
      out.write("                <span class=\"label label-info\">Enter Full name</span>\n");
      out.write("                <input type=\"text\" class=\"input-block-level validate[required]\" placeholder=\"full name\" name=\"fullname\"/>\n");
      out.write("                <span class=\"label label-info\">Enter User name</span>\n");
      out.write("                <input type=\"text\" class=\"input-block-level validate[required]\" placeholder=\"username\" name=\"username\"/>\n");
