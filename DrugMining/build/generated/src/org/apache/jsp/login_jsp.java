        ...
        else
{
    ...
    if (flash_message != null) {
      ...
      out.write("                <h2 class=\"form-signin-heading\">Admin Login</h2>\n");
      out.write("                <div id=\"myTabContent\" class=\"tab-content\">\n");
      out.write("                    <input type=\"text\" class=\"input-block-level validate[required,minSize[3]]\" placeholder=\"username\" name=\"username\" >\n");
      out.write("                    <input type=\"password\" class=\"input-block-level validate[required]\" placeholder=\"password\" name=\"password\">\n");
      out.write("                    <button class=\"btn btn-large btn-primary\" type=\"submit\">Log In</button>\n");
      out.write("                </div>\n");
      out.write("            </form>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"span5\">\n");
      out.write("            <form class=\"form-signin\" action=\"UserLogin\" method=\"post\">\n");
      out.write("                <h2 class=\"form-signin-heading\">User Login</h2>\n");
      out.write("                <div id=\"myTabContent\" class=\"tab-content\">\n");
      out.write("                    <input type=\"text\" class=\"input-block-level validate[required,minSize[3]]\" placeholder=\"username\" name=\"username\" >\n");
      out.write("                    <input type=\"password\" class=\"input-block-level validate[required]\" placeholder=\"password\" name=\"password\">\n");
      out.write("                    <button class=\"btn btn-large btn-primary\" type=\"submit\">Log In</button>\n");
