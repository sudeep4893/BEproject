...
public final class view_005freviews_jsp extends org.apache.jasper.runtime.HttpJspBase
        ...
        else
{
    ...
    if (flash_message != null) {
      ...
      out.write("            {\n");
      out.write("                var data = document.getElementById(\"drug_meds\");\n");
      out.write("                \n");
      ...
      out.write("            }\n");
      out.write("            \n");
      out.write("            function loadRevs()\n");
      out.write("            {\n");
      out.write("                var data = document.getElementById(\"drug_meds\");\n");
      out.write("                var datamed = document.getElementById(\"meds\");\n");
      out.write("                \n");
      out.write("                var XmlHttpObject;\n");
      out.write("                if (window.XMLHttpRequest) {\n");
      out.write("                    XmlHttpObject = new XMLHttpRequest();\n");
      ...
      out.write("                if(data.options[data.selectedIndex].value>0)\n");
      out.write("                    {\n");
      out.write("                XmlHttpObject.open('get', 'get_reviews.jsp?data='+data.options[data.selectedIndex].value+'&datamed=' + datamed.options[datamed.selectedIndex].value , true);\n");
      out.write("                XmlHttpObject.onreadystatechange=function(){\n");
      out.write("                    if (XmlHttpObject.readyState==4 && XmlHttpObject.status==200){\n");
      out.write("                        document.getElementById(\"revws\").innerHTML=XmlHttpObject.responseText;\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("                XmlHttpObject.send();\n");
      out.write("                }\n");
      out.write("                else{\n");
      out.write("                    alert(\"Select the Medicine Type\");\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("    </head>\n");
      ...
      out.write("                    <center><br/><br/>Select Drug Category : <select id=\"drug_meds\" name=\"drug\" onchange=\"loadData()\">\n");
